...
type Props = CompositeScreenProps<
  NativeStackScreenProps<BusquedaStackParamList, "BusquedaUsuario">,
  NativeStackScreenProps<HomeStackParamList>
>;

function BusquedaUsuarioScreen({ navigation }: Props) {
  const { colors } = useTheme();
  const [selectedButton] = useState<ButtonValue>("BusquedaUsuario");
