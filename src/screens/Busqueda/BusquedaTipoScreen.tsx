...
type Props = CompositeScreenProps<
  NativeStackScreenProps<BusquedaStackParamList, "BusquedaTipo">,
  NativeStackScreenProps<HomeStackParamList>
>;

function BusquedaTipoScreen({ navigation }: Props) {
  const { colors } = useTheme();
  const [selectedButton] = useState<ButtonValue>("BusquedaTipo");
